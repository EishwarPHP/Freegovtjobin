...
<div id="page-wrapper">
    <div class="main-page">
        <div class="forms">
            ...
            <div class="row">
                <h3 class="title1"><small class="text-right">Home / Enquiry</small></h3>
                {{-- Success message --}}
                                ...
                                @foreach ($enquiry as $res)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('deleteEnquiry') }}/{{ $res->id }}"> <i class="fa fa-trash btn-danger btn btn-xs" title="Delete" onclick="return confirm('Are you Sure you want to delete this record')"></i> </a>
                                        </td>
                                    </tr>
                                @endforeach
                            </table>
