                                ...
                                @foreach ($subscriptions as $res)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('deleteSubscribe') }}/{{ $res->id }}"> <i class="fa fa-trash btn-danger btn btn-xs" title="Delete" onclick="return confirm('Are you Sure you want to delete this record')"></i> </a>
                                        </td>
                                    </tr>
                                @endforeach
                            </table>
